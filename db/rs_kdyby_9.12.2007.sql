...
-- 
-- Počítač: localhost
-- Vygenerováno: Neděle 09. prosince 2007, 16:58
-- Verze MySQL: 5.0.27
-- Verze PHP: 5.2.0
-- 
-- Databáze: `rs_kdyby`
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 19:39
-- Poslední změna: Sobota 08. prosince 2007, 21:37
-- 
...
INSERT INTO `block` (`id`, `name`, `location`, `width`, `height`, `top`, `left`, `pages`, `template`, `style_id`) VALUES 
(1, 'Hlavicka', '1', '', '', '', '', '', '', 'header'),
(2, 'Menu', '2', '', '', '', '', '', '', 'column_1'),
(3, 'Obsah', '2', '', '', '', '', '', 'text.html', 'right'),
(4, 'Paticka', '3', '', '', '', '', '', 'toe.html', 'toe');
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 19:40
-- Poslední změna: Neděle 09. prosince 2007, 16:10
-- 

DROP TABLE IF EXISTS `block_contain`;
...
INSERT INTO `block_contain` (`id`, `block`, `name`, `type`, `data`, `priority`, `pages`, `template`, `style_id`, `desc`) VALUES 
(1, 2, 'Menu', 2, '2 view 1', 1, '', '', '', ''),
(2, 3, 'Článek - Úvod', 3, '1', 1, '<page:uvod>', '', '', ''),
(3, 4, 'Pata', 3, '2', 1, '', '', '', ''),
(4, 3, 'Článek - Webdesign', 3, '3', 1, '<page:webdesign>', '', '', ''),
(5, 3, 'Kontakt - HosipLan', 3, '4 <user:HosipLan>', 1, '<page:kontakt>', '', '', ''),
(6, 3, 'Kontakt - Borci', 3, '5 <user:Borci>', 1, '<page:kontakt>', '', '', ''),
(7, 3, 'Blog', 2, '3 view news', 1, '<page:blog> <page:default>', '', '', '');
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 18:13
-- Poslední změna: Pátek 07. prosince 2007, 18:13
-- 

DROP TABLE IF EXISTS `block_contain_type`;
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 19:30
-- Poslední změna: Pátek 07. prosince 2007, 19:30
-- 

DROP TABLE IF EXISTS `config`;
CREATE TABLE `config` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `type` int(111) unsigned NOT NULL,
  `data` varchar(100) NOT NULL,
...
-- 
-- Struktura tabulky `config_type`
-- 
-- Vytvoření: Pátek 07. prosince 2007, 19:33
-- Poslední změna: Pátek 07. prosince 2007, 19:33
-- 
...
-- 
-- Vypisuji data pro tabulku `config_type`
-- 
...
-- 
-- Vytvoření: Neděle 09. prosince 2007, 16:37
-- Poslední změna: Neděle 09. prosince 2007, 16:40
-- 

DROP TABLE IF EXISTS `mod_blog_articles`;
...
INSERT INTO `mod_blog_articles` (`id`, `header`, `article`, `article_fp`, `autor`, `autor_nick`, `added`, `num_read`, `category`, `pages`, `confirmed`) VALUES 
(1, 'Lorem ipsum dolor sit amet, consectetuer adipiscing el
'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer interdum lobortis est. Fusce congue. Morbi id risus varius dui iaculis lobortis. Proin placerat. Nunc urna. Aliquam accumsan scelerisque augue. Fusce neque. Cras nonummy. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', 0, 'HosipLan', 1197214050, 0, 1, '<clanek:Lorem-ipsum-dolor-sit-amet-consectetuer -adipiscing-elit> <clanek:1>', '1');
...
DROP TABLE IF EXISTS `mod_blog_groups`;
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 18:13
-- Poslední změna: Sobota 08. prosince 2007, 20:43
-- 
...
(1, 'Navigace', 'vertical', '0'),
(2, 'Kontakt', 'vertical', '0');
...
DROP TABLE IF EXISTS `mod_menu_element`;
...
DROP TABLE IF EXISTS `mod_menu_perm`;
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 18:13
-- Poslední změna: Neděle 09. prosince 2007, 15:55
-- 
...
(3, '0', 'blog.php', 'Blog', '0.9a', 'view + admin', 'HosipLan', 'utf-8', '2.12.2007', 'Obsahuje funkce, které umožní udělat na stránkách blog');
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 18:13
-- Poslední změna: Sobota 08. prosince 2007, 20:40
-- 
...
(13, '<file:index>', 'stylesheet', './css.php', '<link rel="stylesheet" href="@data" type="text/css">', 'Tag který slouží k připojení tabulek stylů ke stránce.');
...
-- 
-- Vytvoření: Sobota 08. prosince 2007, 21:38
-- Poslední změna: Neděle 09. prosince 2007, 16:17
-- 
...
CREATE TABLE `page_text` (
  ...
  `article` enum('0','1') NOT NULL default '0',
  `break` enum('0','1') NOT NULL default '0',
...
-- 
-- Vytvoření: Pátek 07. prosince 2007, 23:25
-- Poslední změna: Pátek 07. prosince 2007, 23:41
-- 
...
INSERT INTO `styles` (`id`, `enabled`, `default`, `folder`, `name`, `desc`) VALUES 
(1, 1, 1, 'evolution', 'Evolution', 'Základní styl mého Blogu'),
(2, 0, 0, 'kdyby', 'KdybyRS', 'Univerzální styl pro KdybyRS');

-- --------------------------------------------------------

-- 
-- Struktura tabulky `styles_description`
-- 
-- Vytvoření: Pátek 07. prosince 2007, 22:50
-- Poslední změna: Pátek 07. prosince 2007, 23:30
-- 

DROP TABLE IF EXISTS `styles_description`;
CREATE TABLE `styles_description` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `style` int(11) unsigned NOT NULL,
...
-- 
-- Vypisuji data pro tabulku `styles_description`
-- 

INSERT INTO `styles_description` (`id`, `style`, `attr`, `data`) VALUES 
(1, 1, 'version', '1.0a'),
(2, 1, 'writer', 'HosipLan'),
(3, 1, 'designer', 'lamedesign'),
(4, 1, 'published', '6.12.2007'),
(5, 2, 'version', '1.0a'),
(6, 2, 'writer', 'HosipLan'),
(7, 2, 'published', '25.11.2007');
...
DROP TABLE IF EXISTS `user_groups_mbr`;
...
DROP TABLE IF EXISTS `user_groups_perm`;
